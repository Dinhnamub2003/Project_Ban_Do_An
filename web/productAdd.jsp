        ...
        <section class="home-section">
            ...
            <div class="sales-boxes">
                <div style="width: 100%" class="recent-sales box">
                    ...
                    <form style="margin-left: 100px" action="producta"  method="post">
                        <div class="row">
                            <div  class="col-25">
                                <label for="fname">ID</label>
                            </div>
                            <div class="col-75">
                                <input type="text" readonly id="fname" name="id" value="${c}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-75">
                                <input type="date"  name="dateupdate" >
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-75">
                                <textarea id="subject" name="describe"  style="height:150px"></textarea>
                            </div>
                        </div>
                        <div class="row">
