            ...
            <div class="sales-boxes">
                <div style="width: 100%" class="recent-sales box">
                    <div style="display: flex;">
                        <div style="margin-left: 30px" class="title">Manager Payment</div>
                        <div style="margin-left:50px" class="title"><a href="paymenta" > Add New Payment </a></div>
                            ...
                            <tbody  style="margin-left: 20px">
                                <c:forEach items="${list2}" var="p">
                                    <tr >
                                        ...
                                        <td>${p.orderid}</td>
                                        <td>
                                            <a href="paymentu?id=${p.paymentid}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>

                                            <a href="paymentd?id=${p.paymentid}" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
