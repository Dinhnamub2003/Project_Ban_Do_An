            ...
            <div class="home-content">
                ...
                <div class="sales-boxes">
                    ...
                    <div class="recent-sales box">
                        ...
                        <form action="staffu?id=${top.id}" method="post">
                            Name
                            <div style="margin-bottom:  15px;" class="sales-details">
                                ...
                                <input style="width: 100%"  type="text" name="name" value="${o.username}" /> 
                            ...
                            <div style="margin-bottom:  15px;" class="sales-details">
                                ...
                                <input style="width: 100%"  type="text" name="phone" value="${o.address}" /><br>
                            ...
                            <div style="margin-bottom:  15px;" class="sales-details">
                                ...
                                <input style="width: 100%"  type="date" name="birth" value="${o.realname}" /><br>
                            ...
                            <div style="margin-bottom:  15px;" class="sales-details">
                                ...
                                <input style="width: 100%"  type="text" name="email" value="${o.password}" /><br>
                            ...
                            <div style="margin-bottom:  15px;" class="sales-details">
                                ...
                                <input style="width: 100%" type="text" name="country" value="${o.phone}" />
