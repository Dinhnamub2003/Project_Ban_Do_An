            ...
            <div class="card">
                ...
                <div class="card__body">
                    ...
                    <div style="margin-left: 10px" class="half">
                        ...
                        <h4 style="font-family: cursive ; color :green ; margin-top: 20px;
                            text-align:  center"> View:${view}</h4>
                    </div>
                </div>
                <div class="card__footer">
                    <div class="recommend">

                        <p  style="font-family: fantasy; color :olive">Kibyhunter Food</p>
                        <h3 style="font-family: cursive; color :olive" >The Kitten Of The World</h3>
                    </div>
                    <div class="action">
                        <a style="background: goldenrod; padding: 5px; border-radius: 5px;color: white" href="addcart?id=${requestScope.detail.id}&user=${requestScope.user1}&key=${ffgb}">Add to cart</a>
                    </div>
                                    ...
                                    <div>
                                        <div style="margin-top: 15px" class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="user d-flex flex-row align-items-center">
                                                ...
                                                <span><small class="font-weight-bold text-primary">${c.idaccount.realname}</small> 
                                                    <small class="font-weight-bold"> ${c.content}</small></span>
                                            </div>
                                        ...
                                        <div class="action d-flex justify-content-between mt-2 align-items-center">
                                            <div class="reply px-4">
                                                ...
                                                <small><a href="reviewup?reviewid=${c.reviewid}&id=${requestScope.detail.id}&user=${requestScope.user1}">Update</a></small>
                                                <span class="dots"></span>
                                                <small>Reply</small>
                                                <span class="dots"></span>
