 ...
 * @author Truong cun
 */
@WebServlet(name="thongkeloinhuanThang", urlPatterns={"/thongkeloinhuanThang"})
public class thongkeloinhuanThang extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet thongkeloinhuanThang</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet thongkeloinhuanThang at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
       ...
       List<String> list = d.thongke();
        ...
        request.getRequestDispatcher("thongkeloinhuanThang.jsp").forward(request, response);
    } 
