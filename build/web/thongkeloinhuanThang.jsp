                ...
                <div class="overview-boxes">
                    ...
                    <div class="box">
                        <div class="right-side">
                            ...
                            <div class="indicator">
                                <i class='bx bx-up-arrow-alt'></i>
                                <span class="text"><a  href="#">Statistic Profit</a></span>
                            </div>
                        </div>
                ...
                <script>// Graph
                    ...
                    new Chart(document.getElementById("horizontalBar"), {
                        ...
                        "data": {
                            ...
                            "datasets": [{
                                    "label": "Profit $-$",
                                    "data": [${totalMoneyMonth12*0.3}, ${totalMoneyMonth11*0.3}, ${totalMoneyMonth10*0.3}, ${totalMoneyMonth9*0.3}, ${totalMoneyMonth8*0.3}, ${totalMoneyMonth7*0.3}, ${totalMoneyMonth6*0.3}, ${totalMoneyMonth5*0.3}, ${totalMoneyMonth4*0.3}, ${totalMoneyMonth3*0.3}, ${totalMoneyMonth2*0.3}, ${totalMoneyMonth1*0.3}],
