                        ...
                        <section  class="mb-4" id="doanhThuThang">
                            <div class="card">
                                <div class="card-header py-3">
                                    <h5 class="mb-0 text-center"><strong>Sale By Year</strong></h5>
                                     <select onchange="this.form.submit()" name="chart" style="background-color: orange ; padding: 5px ;border-radius: 5px ;color: white ">
                                            <option ${chart1=="tuan"?"selected":""} value="tuan" >Week</option>
                                            <option ${chart1=="thang"?"selected":""} value="thang">Month</option>
                                            <option ${chart1=="pie"?"selected":""} value="nam">Year</option>
                                            
                                        </select>
                                </div>
                                <form id="myForm" action="doanhthutheonam" method="post">
                                    <div class="card-header py-3">
                                        <select onchange="this.form.submit()" name="chart" style="background-color: orange ; padding: 5px ;border-radius: 5px ;color: white ">
