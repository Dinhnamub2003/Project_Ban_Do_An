                ...
                <div class="profile-nav col-md-3">
                    <div class="panel">
                        <div class="user-heading round">
                            <a href="#">
                                <img src="${requestScope.user.avatar}" alt="Not Found">
                        ...
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li><a href="recent?user=${requestScope.user.username}&id=${requestScope.user.id}"> <i class="fa fa-calendar"></i> Recent Activity <span class="label label-warning pull-right r-activity">9</span></a></li>
                            <li><a href="changep?user=${requestScope.user.username}"> <i class="fa fa-edit"></i> Edit profile</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body bio-graph-info">
                            ...
                            <div class="row">
                                ...
                                <div class="bio-row">
                                    <p><span>Name </span>: ${a.realname}  </p>
                                </div>
                                <div class="bio-row">
                                    <p><span>Address </span>:  ${a.address}</p>
                                </div>
                                <div class="bio-row">
                                    <p><span>Nickname</span>:  ${a.username}</p>
                                </div>
                                <div class="bio-row">
                                    <p><span>Role </span>: ${a.role} of Kibyunter</p>
                                </div>
                                <div class="bio-row">
                                    <p><span>Email </span>:  ${a.email}</p>
                                </div>
                                <div class="bio-row">
                                    <p><span>Avatar </span>:  ${a.avatar} </p>
                                </div>
                                <div class="bio-row">
