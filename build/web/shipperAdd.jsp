            ...
            <div class="home-content">
                ...
                <div class="sales-boxes">
                    ...
                    <div class="recent-sales box">
                        ...
                        <form action="shippera" method="post" >
                            ...
                            <div style="margin-bottom:  15px;" class="sales-details">
                                ...
                                <input style="width: 100%"  type="text" name="id" value="${highest}" readonly /> 
                            ...
                            <div style="margin-bottom:  15px;" class="sales-details">
                                ...
                                <input style="width: 100%"  type="text" name="phone"  /><br>
                            ...
                            <input type="submit" value="Add" style="background: goldenrod; border-radius: 5px; color:white;padding: 5px">
                        </form>
