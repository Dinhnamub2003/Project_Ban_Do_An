                ...
                <div class="profile-nav col-md-3">
                    <div class="panel">
                        ...
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li><a href="recent?user=${requestScope.update5.username}&id=${requestScope.update5.id}"> <i class="fa fa-calendar"></i> Recent Activity <span class="label label-warning pull-right r-activity">9</span></a></li>
                            <li class="active"><a > <i class="fa fa-edit"></i> Edit profile</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="profile-info col-md-9">
                    ...
                    <div class="panel">
                        <div class="bio-graph-heading">
                            Kibyhunter Food The Kitten Of The World :>> 
                        ...
                        <c:set var="a" value="${requestScope.update5}" />
                        <div class="panel-body bio-graph-info">
                            ...
                            <form action="changep" method="post">
                                ...
                                <div class="bio-row">
                                    <p><span> ID </span>: 
                                        <input type="number" readonly name="id" value="${a.id}"/> 
                                    </p>
                                </div>
                                <div class="bio-row">
                                    <p><span>Name </span>: 
                                ...
                                <div class="bio-row">
                                    <p><span>Nickname</span>: 
                                        ...
                                        <input type="text" readonly name="username" value="${a.username}"/> 
                                    </p>
                                </div>
                                <div class="bio-row">
                                    <p><span>Role </span>:

                                        <input type="text" readonly  name="role" value="${a.role}"/> 
                                ...
                                <div class="bio-row">
                                    <p><span>Avatar </span>:  
                                        ...
                                        <input type="text"   name="avatar" value="${a.avatar}"/> 
                                ...
                                <div class="bio-row">
                                    <p><span>Phone </span>: 
                                        ...
                                        <input class="btn btn-warning pull-right"
                                               style="margin-right: 150px" type="submit" value="Save">
                            </div>
                            </form>
                        </div>
                    </div>
