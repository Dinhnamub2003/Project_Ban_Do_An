                ...
                <div class="sales-boxes">
                    ...
                    <div class="recent-sales box">
                        ...
                        <div style="font-family: cursive;color:orangered;text-align: center
                             "  class="title">Best Shipper</div>
                        <div style="color: red"> ${mess}</div>

                        <div style="display: flex">

                            <form  action="excelcustomer" method="get"> 
                            ...
                            <a  style="background: goldenrod;color: white ;padding: 4px ;border-radius: 10px
                                ;margin-left: 20px" href="shippera" > Add new shipper </a>
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <c:if  test="${search==null}">
                                                    <a href="shipperu?id=${i.id}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>

                                                </c:if>
                                                <c:if  test="${search!=null}">

                                                    <a href="shipperu?id=${i.id}&key1=${search}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>


                                                </c:if>
                                                <c:if  test="${search==null}">
                                                    <a href="shipperd?id=${i.id}" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>


                                                </c:if>
                                                <c:if  test="${search!=null}">

                                                    <a href="shipperd?id=${i.id}&key1=${search}" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
